...
$(document).ready(function () {
    ...
    $('.feature .content .featHead .col-md-4:nth-child(1) .box').click(function(){
        ...
        slideDown(500).siblings('.featCon').hide()
    });
    ...
    $('.feature .content .featCon .col-md-4:nth-child(1) .box').click(function(){
        ...
        fadeIn(500).siblings('.featConhid').hide()
    });
    ...
    $(' .dashCon .content #save a   ').click(function(e){
        e.preventDefault();
        $('.dashCon .saveChan').slideDown(500)
    });
    ...
    $('.signUp .content .signUpFooter button').click(function(){
        ...
        }else if($('.signUp .content .inputs .slidBox select').val() == "Intermediaries"){
            
            $('.signUp .content .signUpFooter a').attr("href", "AdminDashboard.html")
        }

    });
    ///////////////////////////////////////
    //ADMIN DASHBOARD CREATE ACCOUNT
    $(' .dashCon .content .create ').click(function(e){
        e.preventDefault();
        $('.dashCon .passCre').slideDown(500)
    });
    if($(window).width() <= 545){
        $('.dashCon .content .inputs .slidBox select option.placeholder ').text("Member of regulatory ?");
    }
    ///////////////////////////////////////
    //ADMIN DASHBOARD ACTION
//    $('select#action option').click(function(){
//        if($('select#action').val() == "Unlock Account"){
//            alert('you click 2');
//        }else if($('select#action').val() == "Lock Account"){
//            alert('you click 2');
//        }
//    })
